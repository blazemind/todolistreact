...
function App() {
  ...
  const fetchItems = () => {
    fetch(
      "https://todolist-7b6f1-default-rtdb.asia-southeast1.firebasedatabase.app/items/.json"
    )
  ...
  const deleteTodo = (id) => {
    fetch(
      `https://todolist-7b6f1-default-rtdb.asia-southeast1.firebasedatabase.app/items/${id}.json`,
      {
        method: "DELETE",
      }
    )
